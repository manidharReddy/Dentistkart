...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    view.tag = section;
    NSLog(@"height of scetion view:%f",view.frame.size.height);
    ...
    ((id <RRNCollapsableSectionHeaderProtocol>)view).titleLabel.font=[UIFont systemFontOfSize:[UIScreen mainScreen].bounds.size.width/20];
    ((id <RRNCollapsableSectionHeaderProtocol>)view).titleLabel.textColor = [UIColor colorWithWhite:1.0f alpha:1.0f];
    return view;
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NSLog(@"didselect method called in RRNCollaps");
}
